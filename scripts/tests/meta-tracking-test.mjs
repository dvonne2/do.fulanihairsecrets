...
async function run() {
  ...
  assert.equal(unicodeInitCall[2].fn, sha256(normalizeName('ÃMINA')), 'Unicode firstName should normalize correctly');
  assert.equal(unicodeInitCall[2].ln, sha256(normalizeName('Ãstergaard')), 'Unicode lastName should normalize correctly');
