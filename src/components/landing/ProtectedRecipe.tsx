      ...
      <div className="max-w-3xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="relative bg-card border-2 border-gold/40 rounded-xl overflow-hidden">
          ...
          <div className="pt-16 md:pt-20 pb-10 px-6 md:px-12">
            ...
            {/* Main text */}
            <div className="space-y-6 font-sans text-lg md:text-2xl text-foreground/90 leading-relaxed text-center mb-10">
            ...
            <div className="space-y-4 max-w-md mx-auto mb-10">
              {features.map((feature, i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <span className="font-sans text-lg md:text-2xl text-foreground/90">{feature}</span>
                </div>
              ))}
            </div>

            {/* Explanation */}
            <div className="text-center space-y-2 font-sans text-lg md:text-2xl text-muted-foreground italic">
