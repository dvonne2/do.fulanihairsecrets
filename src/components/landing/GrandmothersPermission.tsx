      ...
      <div className="max-w-3xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="bg-card/50 backdrop-blur-sm rounded-xl p-8 md:p-12 border border-gold/10">
            ...
            {/* Memorial section */}
            <div className={`mt-12 pt-8 border-t border-gold/20 text-center transition-all duration-1000 delay-8000 ${typedText.length >= fullQuote.length ? 'opacity-100' : 'opacity-0'}`}>
