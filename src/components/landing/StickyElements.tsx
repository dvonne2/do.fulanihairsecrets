...
export const StickyElements = ({ 
  ...
  return (
    <>
      ...
      <div 
        className={`fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-t-2 border-destructive/50 py-3 px-4 transition-transform duration-300 ${showStickyBar ? 'translate-y-0' : 'translate-y-full'}`}
      >
