        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <a
              href="#order-form"
              data-form-cta="true"
              className="block w-full bg-gradient-to-r from-[#15803d] to-[#4cae4e] text-white font-sans text-base md:text-lg tracking-widest uppercase py-4 md:py-5 rounded-xl font-bold text-center mb-6 hover:transform hover:-translate-y-2 hover:shadow-lg transition-all duration-300 cta-with-arrow"
            >
