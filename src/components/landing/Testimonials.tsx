...
const testimonials = [
  { 
    name: "Hajia Fatima Al-Maktoum", 
    location: "Banana Island, Lagos", 
    text: "Wallahi, I've spent millions on products from Dubai, London, everywhere. This is the ONLY thing that actually works. My stylist at the Four Seasons couldn't believe my edges.", 
    image: result1 
  },
  { 
    name: "Chief (Mrs.) Adaeze Okonkwo", 
    location: "Maitama, Abuja", 
    text: "When I say this product is worth more than its weight in gold, I mean it. Finally, a Nigerian brand that matches my standards.", 
    image: result2 
  },
  { 
    name: "Alhaja Maryam Ibrahim", 
    location: "Ikoyi, Lagos", 
    text: "I was about to fly to Turkey for a transplant. ₦15 million! My daughter said try this first. SubhanAllah, look at my hair now.", 
    image: result3 
  },
  { 
    name: "Dr. (Mrs.) Oluwaseun Adeleke", 
    location: "Lekki Phase 1", 
    text: "As a consultant dermatologist, I'm very particular. This formula is scientifically sound AND it works. I recommend it to my VIP patients.", 
    image: result4 
  },
  { 
    name: "Princess Zainab Sanusi", 
    location: "Kano / Dubai", 
    text: "I split my time between Nigeria and UAE. Trust me, nothing in Dubai Mall compares. My edges are FULL again.", 
    image: result5 
  },
  { 
    name: "Otunba (Mrs.) Nike Adeyemi", 
    location: "Victoria Island", 
    text: "At my age, I thought my hair glory days were over. This pomade proved me wrong. My grandchildren say I look 20 years younger!", 
    image: result6 
  },
];
