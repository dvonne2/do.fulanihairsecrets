  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
        <button onClick={() => setPaymentMethod('Pay on Delivery')} style={{ padding: 16, borderRadius: 12, border: paymentMethod === 'Pay on Delivery' ? '2px solid #DAA520' : '2px solid #E5E7EB', background: '#fff' }}>
          Pay on Delivery
        </button>
        <button onClick={() => setPaymentMethod('Pay Before Delivery')} style={{ padding: 16, borderRadius: 12, border: paymentMethod === 'Pay Before Delivery' ? '2px solid #DAA520' : '2px solid #E5E7EB', background: '#fff' }}>
          Pay Before Delivery
        </button>
