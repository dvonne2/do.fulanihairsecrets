...
const S: { [key: string]: CSSProperties } = {
  ...
  req: { color: '#D30000' },
  input: { width: '100%', padding: '14px 16px', background: '#F9F9F9', border: '2px solid #B8860B', borderRadius: 10, fontSize: 16, fontWeight: 600, color: '#1a1a1a', outline: 'none', boxSizing: 'border-box' as const, fontFamily: 'inherit' },
  inputFocus: { borderColor: '#B8860B' },
  ...
  hearAboutUsOptionHoverMobile: { background: '#F0F0F0', borderColor: '#B8860B' },
