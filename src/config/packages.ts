...
export const PACKAGES: Package[] = [
  ...
  { id: 'PKG-005', slug: 'family_saves', name: 'Family Saves', price: 215750, originalPrice: 431500, discount: 50, items: 'You will receive: 10 Shampoos + 10 Pomades + 10 Conditioners', supply: '12 Month Supply', freeItems: 'Buy 6 sets of shampoo, pomade and conditioner, get 4 sets free', isPopular: false },
];
